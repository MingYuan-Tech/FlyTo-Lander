...
- AVD 名稱慣例：`flyto_pixel6_api29` / `flyto_pixel6_api33` / `flyto_pixel7_api34`
...
| 配套專案 | 角色 |
|---------|------|
| **[FlyTo](https://flyto.mytechs.com.tw/)**（macOS App） | 桌面端 GPS 模擬工具；負責發送 broadcast 給本 helper |
